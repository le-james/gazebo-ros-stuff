...
def generate_launch_description():
    ...
    # IncludeLaunchDescription basically copy-pastes the code here from a path - stores the path to
    # these python files
    ...
    # or can spawn by using a launch file with the above spawn_entity in it
