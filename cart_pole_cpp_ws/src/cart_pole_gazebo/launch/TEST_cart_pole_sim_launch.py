...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # Another way to launch a custom world - gzserver.launch.py already returns this declare 'world'
        # DeclareLaunchArgument(
        #     'world',
        #     # default_value=[os.path.join(my_gazebo_pkg, 'worlds', 'cart_pole_sim_launch.py')],
        #     default_value=[os.path.join(get_package_share_directory('cart_pole_gazebo'), 'worlds', 'world1.world')],
        #     description='SDF world file'),

        DeclareLaunchArgument(
            'world',
            default_value=[os.path.join(
                get_package_share_directory('cart_pole_gazebo'), 'worlds', 'world1.world')],
            description='SDF world file'),
