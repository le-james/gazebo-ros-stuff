...
: ${AMENT_CURRENT_PREFIX:="/workspaces/gazebo-ros-stuff/vslam_dev_ws/install/camera_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/camera_gazebo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/camera_gazebo/environment/path.sh"
